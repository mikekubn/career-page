  ...
  <AnimatePresence>
    {
      display ? (
        ...
        >
          <div data-cy="notification" className="flex items-center px-4 rounded-lg h-9 w-60 bg-gray text-black sm:bg-sky500/5 sm:text-gray500 lg:h-11 lg:bg-sky500/5 lg:text-gray500">
