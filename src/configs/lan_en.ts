...
const jobs_lan_en: IJob[] = [
  {
    id: '1', image: '/img/work/livesporttv.jpeg', companyName: 'Livesport', date: 'from: 11.2020', where: 'where: Brno, Czech Republic', position: 'Javascript Developer', description: ['React, Next, Nuxt, MSW, Cypress', 'JavaScript, TypeScript', 'Media service development (IPTV)', 'Introduction of QA process Cypress'],
  },
  {
