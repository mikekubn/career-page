...
keywords: ['pnpm', 'nextjs', 'npm', 'npm link', 'pnpm & npm link', 'Michael Kubin', 'blog']
...
excerpt: If you work on bigger project with more packages you will want to use pnpm, probably.
---

### How use npm link in pnpm overwrites

> _If you work on bigger project with more packages you will want to use `pnpm`, probably._
